          ...
          <div className="col-md-5 mb-3 bike">
            <div className="card-text">
              ...
              <div className="slider align-items-center">
                <img src="slike/bikeace.png" alt="Bike"/>
              </div>
              <div className="options-row mb-2 d-flex align-items-end ms-3">
                ...
                <div className="choice">
                  <span className="colorbtn-active"><button type="button" className="btn p-1 btn-crn"><img src="slike/btn1.svg" alt="btn1"/></button>
                  </span>
                  <span className="colorbtn"><button type="button" className="btn p-1 btn-siv"><img src="slike/btn2.svg" alt="btn2"/>          </button></span>
                  <span className="colorbtn"><button type="button" className="btn p-1 btn-bez"><img src="slike/btn3.svg" alt="btn3"/>          </button></span>
                  <span className="colorbtn"><button type="button" className="btn p-1 btn-mix"><img src="slike/btn4.svg" alt="btn4"/>         </button></span>
                </div>
          ...
          <div className="col-md-5 mb-3 bike">
            <div className="card-text">
              ...
              <div className="slider">
                <img src="slike/bikeivy.png" alt="Bike"/>
              </div>
              <div className="options-row mb-2 d-flex align-items-end ms-3">
                ...
                <div className="choice">
                  ...
                  <span className="colorbtn"><button type="button" className="btn p-1 btn-siv"><img src="slike/btn2.svg" alt="btn2"/>          </button></span>
                  <span className="colorbtn"><button type="button" className="btn p-1 btn-bez"><img src="slike/btn3.svg" alt="btn3"/>          </button></span>
                  <span className="colorbtn"><button type="button" className="btn p-1 btn-mix"><img src="slike/btn5.svg" alt="btn4"/>         </button></span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-6">
            <img src="./slike/textlogo.png" alt="textlogo" className="commute-logo"/>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="home-3 py-5">
      <div className="container">
        <div className="row align-items-center">
          <div className="col-md-6">
            <img src="slike/home-3.jpg" alt="naslovna 3. slika" />
          </div>
          <div className="col-md-6">
        ...
        <div className="row">
          <div className="col-md-4">
            <div>
              ...
              <img src="./slike/testimonial-1.png" alt="testiominal-1"/>
            </div>
          </div>
          <div className="col-md-4">
            <div><p>“This second-generation Ace is a
                  ...
                  <img src="./slike/testimonial-2.png" alt="testiominal-2"/>
            </div>
          </div>
          <div className="col-md-4">
            <div><p>"The timeless, chic design and
              ...
              <img src="./slike/testimonial-3.png" alt="testiominal-3"/>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="home-3 py-5">
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            <img src="slike/products-3.jpg" alt="products-3. slika" />
          </div>
